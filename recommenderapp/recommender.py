...
genresmatrix=pd.read_feather('./recommenderapp/static/genresmatrix.feather')
genresmatrix=genresmatrix.set_index("MovieID")
movies=pd.read_feather('./recommenderapp/static/movies.feather')
movies=movies.set_index("MovieID")
categories=pd.read_feather('./recommenderapp/static/categories.feather')
top=20
